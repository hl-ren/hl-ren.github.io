(function () {
  var messages = {
    zh: {
      ...
      "slides.localType": "本地工具",
      "slides.localTitle": "本地 Markdown 播放器",
      "slides.localDescription": "选择一个 md 和图片文件夹，直接在浏览器里播放成 PPT。",
      "slides.localOpen": "打开本地播放器",
      "post.back": "返回文章",
      "post.previous": "上一篇",
      "post.next": "下一篇",
      "comments.title": "评论",
    ...
    en: {
      ...
      "slides.localType": "Local Tool",
      "slides.localTitle": "Local Markdown Player",
      "slides.localDescription": "Choose a Markdown file and asset folder, then present it directly in the browser.",
      "slides.localOpen": "Open Local Player",
